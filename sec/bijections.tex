...
Second, it is apparent that $(I_k,J_k)$ is not a union of other $\LA$ pairs as $1$ is the only element of $I_k$ which is smaller than other elements of $J_k$.
...
Third, we show that any pair $(I,J)$ in $\LA$ which is not of the form $(I_k,J_k):=(\{1,k+2,k+3,\dots,2k-1,2k\}, \{2,3,\dots,k+1\})$ can be decomposed as a union of such pairs. 
