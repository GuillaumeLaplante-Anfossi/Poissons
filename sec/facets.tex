...
\end{itemize}
There are eight essential complementary partitions among the $25$ pairs of partitions:
\begin{itemize}
\item $(\{1\}\{2\}\{3\}
\item 
\item 
...
\end{example}
\Kurt{To do} \BDO{In progress. Is there too many details ? Don't hesitate to modify / correct the formulation}
