...
\DontPrintSemicolon
  ...
  \KwInput{a word $c=c_1 \ldots c_{i}$ and a set $\mathcal{T}$ of $i$ bi-colored trees with white root, except one bi-colored tree with an unlabeled black root}
...
To prove that this algorithm defines a bijection between the pairs of Prüfer code and set of corollas and bipartite rooted trees, let us give the algorithm which convert a rooted bipartite tree in such a pair.
