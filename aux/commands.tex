...
\newcommandx{\braidArrangement}[1][1 = n]{\arrangement_{#1}} % braid arrangement
...
\newcommandx{\charPol}[2][1 = y, 2 = \arrangement]{\b{\chi}_{#2}(#1)} % characteristic polynomial
\newcommandx{\mobPol}[3][1 = x, 2 = y, 3 = \arrangement]{\b{\mu}_{#3}(#1, #2)} % Mobius polynomial
