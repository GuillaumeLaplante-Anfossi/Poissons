...
\end{align}
\end{definition}
The weak facial order recovers the weak order on permutations as illustrated in \cref{fig:Hasse diagram Perm3}.
\begin{figure}
\begin{tikzpicture}
\node (1) at (-1.5, -1) {$3|12$};
...
\end{proposition}
\begin{proof}
Let $\sigma$ be a face of the permutahedra, and let $\sigma^*$ (\resp $\sigma_*)$ denote the unique maximal (minimal) vertex of $\sigma$, under the weak order.
...
\begin{example}
In the context of \cref{ex:subdivision cubes}, $1|234\times 4|3|12 \in \hour^{\SU}$, for $v=4|3|1|2$, and 
\begin{align*}
