...
%
\draw[thick, green] (0) to [in=180, out=0, looseness=0] (9);
\draw[thick, blue, dashed] (1) to [in=180, out=0, looseness=0] (14);
\draw[thick, green] (2) to [in=180, out=0, looseness=0] (11);
\draw[thick, blue] (3) to [in=180, out=0, looseness=0] (8);
\draw[thick, green] (4) to [in=180, out=0, looseness=0] (13);
\draw[thick, blue] (5) to [in=180, out=0, looseness=0] (10);
\draw[thick, green] (6) to [in=180, out=0, looseness=0] (15);
\draw[thick, blue] (7) to [in=180, out=0, looseness=0] (12);
%
\end{tikzpicture}
...
%
\draw[thick, green] (0) to [in=180, out=0, looseness=0] (11);
\draw[thick, blue] (1) to [in=180, out=0, looseness=0] (8);
\draw[thick, green] (2) to [in=180, out=0, looseness=0] (13);
\draw[thick, blue] (3) to [in=180, out=0, looseness=0] (10);
\draw[thick, green] (4) to [in=180, out=0, looseness=0] (15);
\draw[thick, blue] (5) to [in=180, out=0, looseness=0] (12);
\draw[thick, green, dashed] (6) to [in=180, out=0, looseness=0] (9);
\draw[thick, blue] (7) to [in=180, out=0, looseness=0] (14);
%
\end{tikzpicture}
\end{center}
...
In particular, the two center faces of the hexagon (\cref{fig:LUSAdiagonals}) are generated by 
\begin{center}
