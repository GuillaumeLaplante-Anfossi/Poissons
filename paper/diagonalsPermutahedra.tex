...
\begin{figure}[h!]
	...
	\end{center}
	\caption{Cubical realizations $\divcube{1},\divcube{2}$ and $\divcube{3}$ of the permutahedra~$\Perm[2]$, $\Perm[3]$ and $\Perm[4]$, respectively, from \cref{constr:cubicPermutahedron1}.}
	\label{fig:cubicPermutahedron1}
\end{figure}
We indicate, in bold, the embedding $\divcube{n-1}\hookrightarrow \divcube{n}$ induced by the natural embedding $\R^{n-1} \hookrightarrow \R^n$.
Only the vertices of $\divcube{3}$ are labelled, but its edges, facets and outer face are all identified with the expected elements of $\Perm[4]$.
...
The following examples on $\divcube{3}$ are represented in \cref{fig:hourglass1}.
...
are not subdivision cubes of $\divcube{3}$.
...
This defines the hourglass $\hour=\{ 1|234, 13|24, 14|23, 134|2\} \times \{4|3|12\}$ of $\divcube{3}$ at $v$.
...
In the next section, we will show that $\hour$ is generated by all shifts of the $\SCP$ corresponding to $v$.
%
\begin{figure}
	\begin{center}
	{\small
	...
	\end{center}
	\caption{The hourglass~$\hour$ of $\divcube{3}$ at~$v = \blue{\mathbf{4|3|1|2}}$.}
