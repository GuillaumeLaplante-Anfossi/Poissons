...
Then, assuming we have constructed the subdivision of the $(n-1)$-cube $\divcube{n-1}$, we construct $\divcube{n}$ as the subdivision of the polytopal complex $\divcube{n-1} \times [0,1]$ given, for each face $\sigma$ of $\divcube{n-1}$, by the polytopal complex $\sigma \times I_\sigma$. 
...
\begin{align} \label{eq:SU cube inductive def}
	...
	\end{cases}
\end{align}
We obtain a subdivision $\divcube{n}$ of the $n$-dimensional cube isomorphic to the $n$-dimensional permutahedron $\Perm[n+1]$.
\end{construction}
