...
Then, we initiate the study of operadic diagonals (\cref{def:operadicDiagonal}) in \cref{sec:operadicDiagonals}.
These are families of diagonals of the permutahedra which are compatible with the property that the faces of permutahedra are product of lower-dimensional permutahedra. 
