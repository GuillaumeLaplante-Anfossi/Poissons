...
With this identification, we can apply \cref{def:SU-admissible}, to identify $1$-block moveable subsets of the matrix $M$, and we can apply \cref{def:SU-admissible}, to identify sequences of shifts which are admissible of original type.
...
\begin{definition}[{\cite[Def.~7]{SaneblidzeUmble}}]
