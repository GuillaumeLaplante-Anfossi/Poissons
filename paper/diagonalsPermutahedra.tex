...
A pair of permutations of $[n]$ is in the $\LA$ (resp. $\SU$) diagonal if and only if for any~$k\geq 1$ and for any $(I,J) \in \LA(n)$ (resp. $\SU(n)$) of size $|I|=|J|=k$ it avoids the pattern 
\begin{align}
...
\end{align}
where $I=\{i_1,\dots,i_k\}$, $J=\{j_1,\dots,j_k\}$ and $i_1=\min(I\cup J)$ (resp. $j_k=\max(I\cup J)$).
\end{theorem}
...
\Guillaume{C'est la qu'on va obtenir la condition de Hugh;...}
