...
\begin{example}
    Let $U(n):=\{ (I,J) \ | \ I,J \subset [n], |I|=|J|>0, \min(I \cup J) \in I\}$.
...
\begin{corollary}
    Any choice of diagonal of the permutahedron is given combinatorially by a choice of inequalities for all the hyperplanes in 
\end{corollary}

\begin{proof}
    Choice of vector is choice of chamber, mention chamber invariance
\end{proof}
...
\begin{center}
\begin{tikzcd}
    \sigma_{i-n} \arrow[r,squiggly,dash] \arrow[rd,dash,"i_k"]& \tau_{j-m}\\
    \sigma_{i} \arrow[ru,squiggly,dash]  & \tau_j\\
    \sigma_{i+1} \arrow[ru,dash, "\rho"] 
\end{tikzcd}
\end{center}
