...
\Kurt{Maybe hourglass instead?}
\vincent{We hesitated between sandglass and hourglass and decided for the former because it fits the notation~$\subdivpairsev(F)$. But fill free to change to hourglass (and maybe adapt the notation as well?)}
\begin{enumerate}
