...
For the following planar tree, we label each internal edge in infix order by labelling the vertex directly above it, and illustrate the nestings $\{ \{1,2\},\{1,2,3\}, \{1,2,3,4,5\} \}$ and $\{ \{2\},\{2,5\}, \{1,2,3,4,5\} \}$.
\begin{center}
...
\hedge[red, very thick]{0,2,1}{0.3cm}
\hedge[blue, very thick]{0,2,3,1}{0.4cm}
...
\node(0) {0}
   ...
   child{node(5){5}};
% \begin{pgfonlayer}{bg}    % select the background layer
\hedge[red, very thick]{0,2}{0.3cm}
\hedge[blue, very thick]{0,5,2}{0.4cm}
\hedge[green, very thick]{0,5,4,1}{0.5cm}
%\end{pgfonlayer}
\end{tikzpicture}
\end{center}
These two nestings show that the ordered partition $12|3|45 \times 2|35|14\in \LAD$ is valid for this tree.
As a counter example, neither  
$\{ \{1,2\},\{1,2,4,5\}, \{1,2,3,4,5\} \}$ nor $\{ \{3,5\},\{2,3,5\}, \{1,2,3,4,5\} \}$ are nestings of this tree.
