...
Cellular diagonals of the operahedra do \emph{not} satisfy the magical formula, and the difficulty to describe combinatorially their image is what prompted the development of the theory in~\cite{LaplanteAnfossi}.
...
\cref{sec:shifts} is technical, mostly devoted to the proof that the geometric $\SU$ diagonal is a topological enhancement of the original $\SU$ diagonal.
...
Admissible sequence of shifts are defined similarly (simply replace $\sigma$ with $\tau$ in \cref{def:SU-admissible}).
...
In this section, we show that the singleton $1$-shifts defining the operadic diagonal $\LAD$ or $\SUD$ define a lattice structure on the set of facets.
...
We will discuss how this lattice is compatible with a generalised weak order\Guillaume{What is this generalized weak order? Where is it defined?}, and latter we will use it to relate the cubical and shift definitions of the $\SUD$ diagonal in \cref{sec:Cubical}.
