...
\node[anchor=east] (2) at (-1.5, -2) {$\sigma_{i+1}$};
%
\node[anchor=west] (3) at (1.5, -1) {$\tau_{j-m}\setminus \rho$};
...
\begin{align*}
    l_v(\rho) := \max (\{0\}\cup \{m>0: L_{\rho}(\sigma) \text{ is a path admissible $\LA$ $m$-shift} \})\\
    r_v(\rho) := \max (\{0\}\cup \{m>0: R_{\rho}(\tau) \text{ is a path admissible $\LA$ $m$-shift} \})
\end{align*}
...
\begin{align*}
    T_v^\LA \cong \prod_{\rho \in [n]} [0,l_v(\rho)]
	\times \prod_{\rho \in [n]} [0,r_v(\rho)] \ , \quad \text{ and }  T_v^\SU \cong \prod_{\rho \in [n]} [0,r_v(\rho)]
	\times \prod_{\rho \in [n]} [0,l_v(\rho)] \ .
\end{align*}
\end{proposition}
