...
\cref{sec:shifts} is technical, devoted to the proof that the geometric $\SU$ diagonal is a topological enhancement of the original $\SU$ diagonal.
...
\begin{figure}[h!]
	...
	\hline
	Subset shifts & \cite{SaneblidzeUmble} & New \\
	$(I,J)$ conditions & New & \cite{LaplanteAnfossi} \\
	Path extrema & New & New \\
	$1$-shifts & New & New \\
	$m$-shifts & New & New \\
	Lattice & New & New \\
...
Along the way, we present proofs of some results\Guillaume{Cite them here} that were presented there as facts.
