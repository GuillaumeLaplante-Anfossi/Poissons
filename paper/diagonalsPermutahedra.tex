...
Dually, we have the following characterisation of the vertices of the $\SU$ diagonal.
...
\end{proposition}
\begin{proof}
We apply either of face poset isomorphisms $rs \times rs,t(r\times r):\LAD \to \SUD$ (\cref{rem:Alternate Isomorphism}).
