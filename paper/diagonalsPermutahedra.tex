...
There is a natural lattice structure on all ordered partitions which extends the weak order on permutations.
...
\vincent{careful: the notation for the cardinal of~$X$ is~$\card{X}$...}
