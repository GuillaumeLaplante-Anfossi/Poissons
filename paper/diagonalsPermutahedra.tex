...
We present the $(2,7)$-tree $\{15,234,6,7\} \times \{13,2,46,57\}$ (left) and its orderings giving facets of the $\LA$ (middle) and $\SU$ (right) diagonals, according to \cref{thm:facet-ordering}.
\begin{center}
...
\end{align*}
The isomorphism $rs\times rs$ from \cref{thm:bijection-operadic-diagonals} sends the $\LA$ facet to the $\SU$ one
