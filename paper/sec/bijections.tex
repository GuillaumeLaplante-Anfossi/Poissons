...
\begin{definition}
    For $(\sigma,\tau)$ a pair of essential complementary partitions, we denote by $\sigma_{i,j}$ the unique path between blocks $\sigma_{i}$ and $\sigma_j$, and similarly $\tau_{i,j}$.
\end{definition}
