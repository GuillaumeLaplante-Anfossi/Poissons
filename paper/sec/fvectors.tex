...
\begin{proof}
By \cref{prop:flatPosetMultiBraidArrangement,prop:bijectionForests}, we just need to count the well-labeled $(\ell,n)$-rainbow trees with~$k_i$ nodes colored by~$i$.
...
\begin{example}
The number of regions and bounded regions of~$\multiBraidArrangement$ are reported in \cref{table:regionsMultiBraidArrangement}.
