...
\vincent{I still have to decide what I do with this big \cref{table:fvectorlBraidArrangements}.} \BDO{Put it in annexe? No ?}
...
\BDO{C'est Ok ? Je n'ai pas rappelé la définition d'une partition d'ensemble parce que ça m'a l'air quand même assez générique}
