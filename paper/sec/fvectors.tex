...
\begin{figure}
	...
	\caption{A $(3,6)$-forest with its intersection hypergraph (left) and a $(3,6)$-tree with its intersection hypertree \BDO{Changed : hypergraph to hypertree} (right).}
	\label{fig:forests}
\end{figure}
\end{definition}
...
\begin{proof}
\vincent{Berenice, the floor is yours...} \BDO{Thanks ! Which colours do you want for your permutohedra :-)?}
