...
\begin{figure}
	\centerline{\includegraphics[scale=.9]{figures/intersectionPosetBraidArrangement31}}
	\caption{The braid arrangement $\braidArrangement[3]$ (left) and its flat poset~$\flatPoset[{\braidArrangement[3]}]$ (right).}
	\label{fig:braidArrangement31}
\end{figure}

\begin{figure}
	\centerline{\includegraphics[scale=.9]{figures/intersectionPosetBraidArrangement32}}
	\caption{The $(2,3)$-braid arrangement $\lBraidArrangement[3][2]$ (left) and its flat poset~$\flatPoset[{\lBraidArrangement[3][2]}]$ (right).}
